...
function Metro( canvas, graphics ) {
    ...
    function convertGraphics(graphics) {
        if(graphics.edges.length !== 0) {
            graphics.edges = graphics.edges.map( convertEdge );
        }
        return graphics;
        ...
        function convertEdge(e) {
            ...
            edge[0].x = e.startPoint.x;
            edge[0].y = e.startPoint.y;
            edge[1] = [e.endPoint.x, e.endPoint.y];
            edge[1].x = e.endPoint.x;
            edge[1].y = e.endPoint.y;
    ...
    function findVertex(x, y, radius) {
        var i = 0,
            n = state.graphics.vertices.length,
            dx,
            dy,
            d2,
            vertex,
        ...
        for (i = 0; i < n; ++i) {
            vertex = state.graphics.vertices[i];
            dx = x - vertex.x;
            dy = y - vertex.y;
            d2 = dx * dx + dy * dy;
