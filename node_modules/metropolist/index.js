...
function Metro(canvas, cursorCanvas, data) {
    ...
    function viewCheckboxOnChange(layer, isChecked) {
        switch (layer) {
            case 'elevation': elevationViewOnChange(isChecked); break;
            case 'affluence': affluenceViewOnChange(isChecked); break;
            case 'desirability': desirabilityViewOnChange(isChecked); break;
            case 'district': districtViewOnChange(isChecked); break;
            case 'building': buildingViewOnChange(isChecked); break;
        }
    }

    function editCheckboxOnChange(layer, isChecked) {
        switch (layer) {
            case 'elevation': elevationEditOnChange(isChecked); break;
            case 'affluence': affluenceEditOnChange(isChecked); break;
            case 'desirability': desirabilityEditOnChange(isChecked); break;
            case 'district': districtEditOnChange(isChecked); break;
            case 'building': buildingEditOnChange(isChecked); break;
        }
    }

    // view
    function elevationViewOnChange(isChecked) {
        if (isChecked) {
    ...
    function affluenceViewOnChange(isChecked) {
        if (isChecked) {
    ...
    function desirabilityViewOnChange(isChecked) {
        if (isChecked) {
    ...
    function districtViewOnChange(isChecked) {
        if (isChecked) {
    ...
    function buildingViewOnChange(isChecked) {
        if (isChecked) {
    ...
    // edit
    function elevationEditOnChange(isChecked) {
        if (isChecked) {
            state.LAYERS.add(elevation);
    ...
    function affluenceEditOnChange(isChecked) {
        if (isChecked) {
            state.LAYERS.add(affluence);
    ...
    function desirabilityEditOnChange(isChecked) {
        if (isChecked) {
            state.LAYERS.add(desirability);
    ...
    function districtEditOnChange(isChecked) {
        if (isChecked) {
            state.LAYERS.add(district);
    ...
    function buildingEditOnChange(isChecked) {
        if (isChecked) {
            state.LAYERS.add(building);
    ...
    return {
        ...
        viewCheckboxOnChange: viewCheckboxOnChange,
        editCheckboxOnChange: editCheckboxOnChange,
