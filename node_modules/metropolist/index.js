...
function Metro(canvas, cursorCanvas, data) {
    ...
    function diagram2Array(diagram) {
        ...
        diagram.cells = diagram.cells.map(cell => {
            ...
            newCell.site.data = site2Array(cell.site.data);
    ...
    function render() {
        ...
        // drawSites(state.context(), 2, 'black'); // context, lineWidth, lineColor
        // drawEdges(state.context(), 3, 'black'); // context, lineWidth, lineColor

        /* draw docks */
        if (state.LAYERS.has(building)) drawDocks(state.context(), 'rgb(233, 233, 233)', 'rgb(233, 233, 233)', 8.5); // bgColor, edgeColor, lineWidth

        /* draw walls */
        if (state.LAYERS.has(district)) drawWalls(state.context(), 'white', 6.5);
    ...
    // draw sites
    function drawSites(context, radius, color) {
        context.save();
        context.beginPath();
    ...
    // draw edges
    function drawEdges(context, width, color) {
        context.save();
    ...
    // draw line of wall
    function drawWall(context, polygon, color) {
    ...
    function setWallTopology() {
        let topology = computeTopology(state.graphics.diagram);
