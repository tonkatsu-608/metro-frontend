...
function Metro(canvas, cursorCanvas, data) {
        ...
        if (poly.hasOwnProperty('subPolygons') && !isEmpty(poly.subPolygons)) {
            ...
            for (let property in object) {
                ...
                for (let subProperty in object[property]) {
                    ...
                    if (subProperty !== 'length' && subProperty !== 'center' && subProperty !== 'color' && subProperty !== 'rotation' && subProperty !== 'size' && subProperty !== 'type' && subProperty !== 'bounds' && subProperty !== 'buildings') {
                        ...
                        if (subProperty === 'center') {
                            ...
                            // if (object[property]['buildings'].hasOwnProperty('clear')) delete object[property]['buildings']['clear'];
                            // if (object[property]['buildings'].hasOwnProperty('length')) delete object[property]['buildings']['length'];

                            let buildingsArray = [];

                            // for (let buildingProperty in object[property]['buildings']) {
                            //     if (buildingProperty !== 'length' && buildingProperty !== 'center' && buildingProperty !== 'color' && buildingProperty !== 'rotation' && buildingProperty !== 'size' && buildingProperty !== 'type' && buildingProperty !== 'bounds') {
                            //         if (object[property]['buildings'][0] && object[property]['buildings'][1]) {
                            //             buildingArray.push([object[property]['buildings'][0], object[property]['buildings'][1]]);
                            //         } else {
                            //             if (buildingProperty === 'center') {
                            //                 buildingArray.center = [object[property]['buildings']['center'][0], object[property]['buildings']['center'][1]];
                            //             } else if (buildingProperty === 'color') {
                            //                 buildingArray.color = [object[property]['buildings']['color'][0], object[property]['buildings']['color'][1], object[property]['buildings']['color'][2]];
                            //             } else if (buildingProperty === 'rotation') {
                            //                 buildingArray.rotation = object[property]['buildings']['rotation'];
                            //             } else if (buildingProperty === 'size') {
                            //                 buildingArray.size = object[property]['buildings']['size'];
                            //             } else if (buildingProperty === 'type') {
                            //                 buildingArray.type = object[property]['buildings']['type'];
                            //             } else if (buildingProperty === 'bounds') {
                            //                 buildingArray.bounds = object[property]['buildings']['bounds'];
                            //             }
                            //         }
                            //     }
                            // }
                            subArray.buildings = object[property]['buildings'];
                        }
                    }
                }
                array.push(subArray);
        ...
        if (poly.hasOwnProperty('farms') && !isEmpty(poly.farms)) {
            ...
            for (let property in object) {
                ...
                for (let subProperty in object[property]) {
                    ...
                    if (subProperty !== 'length' && subProperty !== 'center' && subProperty !== 'pattern' && subProperty !== 'rotation' && subProperty !== 'size' && subProperty !== 'type' && subProperty !== 'bounds') {
                        subArray.push([object[property][subProperty][0], object[property][subProperty][1]]);
                    } else {
                        if (subProperty === 'center') {
                            subArray.center = [object[property]['center'][0], object[property]['center'][1]];
    ...
    function drawBuildings() {
        ...
        state.graphics.polygons.forEach(p => {
            ...
            p.subPolygons.forEach(subPoly => {
                ...
                drawSubPolygons(subPoly);

                subPoly.buildings.forEach(d => {
                    if (!d || state.transform.k < 2) return;

                    // start drawing building
                    state.context().beginPath();
                    state.context().translate(subPoly.center[0], subPoly.center[1]);
                    state.context().scale(0.8, 0.8);
                    state.context().translate(-subPoly.center[0], -subPoly.center[1]);
                    state.context().translate(d.center[0], d.center[1]);
                    state.context().scale(0.7, 0.7);
                    state.context().translate(-d.center[0], -d.center[1]);
                    state.context().lineWidth = 1;
                    state.context().strokeStyle = 'black';
                    state.context().fillStyle = `rgb( ${d.color[0] - 20}, ${d.color[1] - 20}, ${d.color[2] - 20} )`;
    ...
    function drawSubPolygons(subPolygon) {
        state.context().save();
