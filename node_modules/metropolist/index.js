...
function Metro(canvas, cursorCanvas, data) {
    ...
    function drawDistricts() {
        ...
        state.graphics.polygons.forEach(p => {
            let formedBounds = transformBounds(p.bounds);
            if (!bboxInViewport(formedBounds)) return;
    ...
    function bboxInViewport(box) {
        ...
        return pointInViewport(p1) || pointInViewport(p2) || pointInViewport(p3) || pointInViewport(p4);
    }
