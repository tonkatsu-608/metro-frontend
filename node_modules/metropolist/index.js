...
function Metro(canvas, cursorCanvas, data) {
    ...
    var state = {
        ...
        POLYGON_TYPE_COLOR: {
            ...
            'empty': [253, 242, 205], // light yellow #cbc5b9
        ...
        state.graphics.polygons
            ...
            .forEach(p => {
                ...
                convert2Edges(p.edges)
                    .forEach((e) => {
                        if (!e) return;
                        drawStreet(context, e, 4.5, 'lightgrey');
                    });
                ...
                p.cutLines.forEach(cut => {
                    if (!cut) return;
                    drawStreet(context, cut, 3.5, 'lightgrey');
                });
            });
    ...
    function drawStreet(context, st, width, color) {
        ...
        drawLine(context, st[0], st[1], width, color, true);
