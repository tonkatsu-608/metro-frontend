...
function Metro(canvas, cursorCanvas, data) {
    ...
    function zoomed() {
        if (state.isAltPressed) {
            ...
            state.transform.x = d3.event.transform.k === 1 ? 0 : d3.event.transform.x;
            state.transform.y = d3.event.transform.k === 1 ? 0 : d3.event.transform.y;
            render();
        }
    }
 ...
 * @returns {HTMLCanvasElement}
    ...
    function menu() {
        ...
        let site = findSite(state.pointer[0], state.pointer[1]);
